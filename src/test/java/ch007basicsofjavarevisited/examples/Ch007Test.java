...
public class Ch007Test {
    ...
    public void IntegerTypes() {
        ...
        aLongHas8Bytes = 0L; //add suffix L for long assertEquals(0, aLongHas8Bytes);
        aByteHas1Byte = 0xA; //add prefix 0x for Hex assertEquals(10,aByteHas1Byte);
        anIntHas4Bytes = 010; //add 'zero' prefix for Octal assertEquals(8, anIntHas4Bytes);
    ...
    public void bitwiseShiftOperatorsExplored() {
        ...
        x = Integer.MIN_VALUE; // -ve assertEquals((Integer.MAX_VALUE/2)+1, x>>>1); }
    }
